...
> **Update 2026-06-30 (handoff #7, FastMCP): counter = 2.** MCP server is mock+schema-verified; its live in-app smoke (GUI-session/app-restart) is the next bite, tracked separately from the §11.2 5-handoff full-UI cadence.
